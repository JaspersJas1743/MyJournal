...
public sealed class GetAllCreatedTasksRequestValidator : AbstractValidator<TaskController.GetAllCreatedTasksRequest>
{
	public GetAllCreatedTasksRequestValidator()
	{
